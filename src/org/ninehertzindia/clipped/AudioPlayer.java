    ...
    public void playRingtone() {
        ...
        switch (audioManager.getRingerMode()) {
            case AudioManager.RINGER_MODE_NORMAL:
                ...
                mPlayer.setAudioStreamType(AudioManager.FLAG_PLAY_SOUND);

                
              //  if (IncomingCallScreenActivity.contactVO.getContactDataType() == 0) {
				try {
               ...
               // }
//                else if(IncomingCallScreenActivity.contactVO.getContactDataType() == 1){
//					
//                	try {
//                        mPlayer.setDataSource(IncomingCallScreenActivity.contactVO.getContactDataUrl());
//                        mPlayer.prepare();
//                    } catch (Exception e) {
//                        Log.e(LOG_TAG, "Could not setup media player for ringtone");
//                        mPlayer = null;
...
//                	
//				}
//                else if(IncomingCallScreenActivity.contactVO.getContactDataType() == 2) {
//					
//                	
//                	
//				}
//                else if(IncomingCallScreenActivity.contactVO.getContactDataType() == 3) {
//                	
//                	try {
//                        mPlayer.setDataSource(mContext,
//                                Uri.parse("android.resource://" + mContext.getPackageName() + "/" + R.raw.phone_loud1));
